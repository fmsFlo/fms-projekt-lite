...
export default function SettingsPage() {
  ...
  async function loadSettings() {
    try {
      ...
      if (res.ok) {
        ...
        // Sicherstellen, dass alle Felder initialisiert sind
        setForm({
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    setSuccess(false)
    try {
      // Entferne id, createdAt, updatedAt - diese werden von Prisma verwaltet
      const { id, createdAt, updatedAt, ...dataToSend } = form as any
      // Konvertiere leere Strings zu null für Felder, die optional sind
      ...
      if (!res.ok) {
        ...
        // Detaillierte Fehlermeldung aus Zod-Validierung
  ...
  const [activeTab, setActiveTab] = useState<'kontakt' | 'branding' | 'zahlung' | 'integrationen' | 'benutzer'>('kontakt')
    ...
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      <form onSubmit={onSubmit} className="space-y-6">
        ...
        {activeTab === 'kontakt' && (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              ...
              <input name="personalName" value={form.personalName} onChange={onChange} className="w-full" />
            </div>
            <div>
              <label className="block text-sm mb-1">E-Mail-Adresse</label>
              <input name="personalEmail" type="email" value={form.personalEmail} onChange={onChange} className="w-full" />
            </div>
            <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-3">
              <div>
                <label className="block text-sm mb-1">Straße/Hausnummer *</label>
                <input name="personalStreet" value={form.personalStreet} onChange={onChange} className="w-full" />
              </div>
              <div>
                <label className="block text-sm mb-1">Nr.</label>
                <input name="personalHouseNumber" value={form.personalHouseNumber} onChange={onChange} className="w-full" />
              </div>
            </div>
            <div>
              <label className="block text-sm mb-1">PLZ *</label>
              <input name="personalZip" value={form.personalZip} onChange={onChange} className="w-full" />
            </div>
            <div>
              <label className="block text-sm mb-1">Stadt *</label>
              <input name="personalCity" value={form.personalCity} onChange={onChange} className="w-full" />
            </div>
            <div>
              <label className="block text-sm mb-1">Telefonnummer *</label>
              <input name="personalPhone" value={form.personalPhone} onChange={onChange} className="w-full" />
            </div>
            <div>
              <label className="block text-sm mb-1">Webseite</label>
              <input name="personalWebsite" value={form.personalWebsite} onChange={onChange} className="w-full" />
            </div>
          </div>
        </section>
        ...
        <section className="border rounded p-4">
          ...
          <h2 className="text-lg font-semibold mb-4">Gewerbliche Kontaktdaten</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
              <label className="block text-sm mb-1">Firmenname *</label>
              <input name="companyName" value={form.companyName} onChange={onChange} className="w-full" />
            </div>
            <div>
              <label className="block text-sm mb-1">Ansprechpartner *</label>
              <input name="contactPerson" value={form.contactPerson} onChange={onChange} className="w-full" />
            </div>
            <div>
              <label className="block text-sm mb-1">E-Mail-Adresse</label>
              <input name="companyEmail" type="email" value={form.companyEmail} onChange={onChange} className="w-full" />
            </div>
            <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-3">
              <div>
                <label className="block text-sm mb-1">Straße/Hausnummer *</label>
                <input name="companyStreet" value={form.companyStreet} onChange={onChange} className="w-full" />
              </div>
              <div>
                <label className="block text-sm mb-1">Nr.</label>
                <input name="companyHouseNumber" value={form.companyHouseNumber} onChange={onChange} className="w-full" />
              </div>
            </div>
            <div>
              <label className="block text-sm mb-1">PLZ *</label>
              <input name="companyZip" value={form.companyZip} onChange={onChange} className="w-full" />
            </div>
            <div>
              <label className="block text-sm mb-1">Stadt *</label>
              <input name="companyCity" value={form.companyCity} onChange={onChange} className="w-full" />
            </div>
            <div>
              <label className="block text-sm mb-1">Telefonnummer *</label>
              <input name="companyPhone" value={form.companyPhone} onChange={onChange} className="w-full" />
            </div>
            <div>
              <label className="block text-sm mb-1">Webseite</label>
              <input name="companyWebsite" value={form.companyWebsite} onChange={onChange} className="w-full" />
            </div>
          </div>
        </section>

        <section className="border rounded p-4">
          <h2 className="text-lg font-semibold mb-4">Abweichende Rechnungsadresse</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-3">
              <div>
                <label className="block text-sm mb-1">Straße/Hausnummer</label>
                <input name="billingStreet" value={form.billingStreet} onChange={onChange} className="w-full" />
              </div>
              <div>
                <label className="block text-sm mb-1">Nr.</label>
                <input name="billingHouseNumber" value={form.billingHouseNumber} onChange={onChange} className="w-full" />
              </div>
            </div>
            <div>
              <label className="block text-sm mb-1">PLZ</label>
              <input name="billingZip" value={form.billingZip} onChange={onChange} className="w-full" />
            </div>
            <div>
              <label className="block text-sm mb-1">Stadt</label>
              <input name="billingCity" value={form.billingCity} onChange={onChange} className="w-full" />
            </div>
            <div>
              <label className="block text-sm mb-1">E-Mail-Adresse</label>
              <input name="billingEmail" type="email" value={form.billingEmail} onChange={onChange} className="w-full" />
            </div>
          </div>
        </section>
        ...
        <section className="border rounded p-4">
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div>
              ...
              <input name="companySlogan" value={form.companySlogan} onChange={onChange} className="w-full" placeholder="z.B. finance made simple" />
        ...
        <section className="border rounded p-4">
          ...
          <div className="grid grid-cols-1 gap-3">
            <div>
              ...
              <input name="advisorIban" value={form.advisorIban} onChange={onChange} className="w-full" placeholder="DE89 3704 0044 0532 0130 00" />
            ...
            <div>
              ...
              <input name="paymentSubject" value={form.paymentSubject} onChange={onChange} className="w-full" placeholder="z.B. Vertrag - [Kundenname]" />
            ...
            <div>
              ...
              <input name="creditorId" value={form.creditorId} onChange={onChange} className="w-full" placeholder="DE98ZZZ09999999999" />
        ...
        <section className="border rounded p-4">
          <h2 className="text-lg font-semibold mb-4">Sevdesk Integration</h2>
          <div className="bg-blue-50 border border-blue-200 rounded p-3 mb-4 flex items-start gap-2">
            <span className="text-blue-600 text-xl">ℹ️</span>
            <p className="text-sm text-blue-800">
                    ...
                    onClick={async () => {
                      ...
                      try {
                        ...
                        if (data.success) {
                          ...
                          // Stelle sicher, dass error als String angezeigt wird
        ...
        <section className="border rounded p-4">
          <h2 className="text-lg font-semibold mb-4">Make Integration</h2>
          <div className="grid grid-cols-1 gap-3">
            <div>
              <label className="block text-sm mb-1">Make Webhook URL</label>
              <input name="makeWebhookUrl" type="url" value={form.makeWebhookUrl} onChange={onChange} className="w-full" placeholder="https://hook.eu2.make.com/..." />
            ...
            <div>
              ...
              <input name="makeApiKey" type="password" value={form.makeApiKey} onChange={onChange} className="w-full" placeholder="API-Key..." />
        ...
        <section className="border rounded p-4">
          <h2 className="text-lg font-semibold mb-4">Close Integration</h2>
          <div className="bg-blue-50 border border-blue-200 rounded p-3 mb-4 flex items-start gap-2">
            <span className="text-blue-600 text-xl">ℹ️</span>
            <p className="text-sm text-blue-800">
